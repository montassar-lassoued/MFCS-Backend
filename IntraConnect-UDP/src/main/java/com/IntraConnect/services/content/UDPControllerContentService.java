...
@Service
public class UDPControllerContentService extends ControllerContentService {
	
	private static final Logger log = LoggerFactory.getLogger(UDPControllerContentService.class);
